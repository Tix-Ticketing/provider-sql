...
// isJWT returns true when the user authenticates via JWT rather than a password.
func isJWT(u *v1alpha1.User) bool {
	p := u.Spec.ForProvider.AuthPlugin
	return p != nil && *p == v1alpha1.AuthPluginJWT
}
