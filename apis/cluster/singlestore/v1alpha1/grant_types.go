...
// GrantParameters define the desired state of a SingleStore grant instance.
type GrantParameters struct {
	// Privileges to be granted.
	// See https://docs.singlestore.com/cloud/reference/sql-reference/security-management-commands/grant/ for available privileges.
...
// A GrantObservation represents the observed state of a SingleStore grant.
...
// A Grant represents the declarative state of a SingleStore grant.
